      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <BarChart data={costCurve} layout="vertical" margin={{ top: 10, right: 50, left: 10, bottom: 10 }} barSize={24}>
            ...
            <XAxis type="number" tick={{ fontSize: 12, fill: '#888' }} domain={[0, 14]} axisLine={{ stroke: '#e0e0e0' }} tickLine={false} label={{ value: '万元/吨', position: 'insideBottomRight', style: { fontSize: 12, fill: '#999' } }} />
