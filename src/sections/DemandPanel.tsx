...
const SEGMENTS = [
  ...
  {
    id: 'grid_storage', name: '电网侧储能', sub: '新型电力系统刚需', color: '#FF6F00',
    assumption: '新型电力系统建设加速，136号文明确独立储能市场主体地位。2026年新增装机预计25GW/50GWh。',
  },
  {
  ...
  {
    id: 'portable_power', name: '便携式储能', sub: '户外应急备电', color: '#FFC107',
    assumption: '户外露营、应急备电需求增长。北美市场占比60%，中国品牌（华宝新能、正浩创新）全球市占率超70%。',
  },
  {
    id: 'electric_ship', name: '电动船舶', sub: '内河运输电动化', color: '#FFD54F',
    assumption: '内河运输电动化加速，长江流域电动船舶试点扩大。单船带电量500-2000kWh。欧洲内河航运碳排放法规推动电动化。',
  },
  {
    id: 'electric_aviation', name: '电动航空', sub: '城市空中交通试点', color: '#FFE082',
    assumption: '城市空中交通（UAM）商业化试点。亿航、小鹏汇天等企业2026年开始小规模商业运营。单机带电150-300kWh。',
  },
  {
